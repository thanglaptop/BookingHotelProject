                ...
                <form id="formAddHotel" class="row g-3 needs-validation"action="{{ route('updatehotel', ['hid' => $hotel->h_id]) }}" method="POST" novalidate
                    ...
                    <div class="col-12" id="add-hotel-image">
                        <div class="zone-display-image scroll-1 border border-secondary" id="displayImage">
                            @foreach ($hotel->hotel_imgs->sortBy('hi_vitri') as $himg)
                                <div class="image-container draggable" draggable="true">
                                    ...
                                    <img src="{{ '/images/hotels/h' . $hotel->h_id . '/' . $himg->hi_name }}"
                                        ...
                                        <input type="hidden" name="newhinh[]" value="{{$himg->hi_name}}">
                                </div>
                            @endforeach
                    ...
                    <div class="col-4">
                        ...
                        <select class="form-select border-secondary" id="add-hotel-type" name="loaihinh" required>
                    ...
                    <div class="col-4">
                        ...
                        <select class="form-select border-secondary" id="add-hotel-city" name="city" required>
                    ...
                    <div class="col-4">
                        ...
                        <select class="form-select border-secondary" id="edit-hotel-pm" name="tttt" required>
                        ...
                        <div class="row g-2 mt-1">
                            @foreach ($tiennghihotel as $tn)
                                <div class="form-check col-3 col-md-2">
                                    <input class="form-check-input border-secondary" type="checkbox" value="{{$tn->tn_id}}"
                                        id="add-room-utilities" @if (in_array($tn->tn_id, $listTnOfHotel)) checked @endif name="tiennghi[]">
