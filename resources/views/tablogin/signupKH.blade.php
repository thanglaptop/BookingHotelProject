<div id="DangKyTaiKhoan" class="choLogin p-3">
    <form id="signUpCus" class="row g-3 needs-validation" action="" novalidate>
        <div class="col-12">
        ...
        <div class="col-12">
            ...
            <input type="text" class="form-control phone-input" id="signUpPhone" required>
        ...
        <div class="col-12">
            ...
            <input type="password" class="form-control pw2-input" id="signUpPass" required>
